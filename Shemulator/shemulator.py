...
import volatility.plugins.shemulator_api as shemu
...
class volshell(common.AbstractWindowsCommand):
    ...
    def render_text(self, _outfd, _data):
        ...
        def emu( address,
            ...
            space = self._proc.get_process_address_space()
            s = shemu.shemulator(space, step, max_inst, dis_mode, print_regs, stuff, inst_dump, dump_blocks, v, patch, brk, dump_dir)
            s.emu(address)
